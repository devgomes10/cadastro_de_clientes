package com.example.cadastrodecontatos
...
import com.example.cadastrodecontatos.database.repository.ContatoRepository
import com.example.cadastrodecontatos.ui.theme.CadastroDeContatosTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            CadastroDeContatosTheme {
